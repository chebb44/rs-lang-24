...
export const sections = [
  { title: 'Начать обучение', path: routes.learn, svgClass: 1 },
  { title: 'Мини-игра Аудиовызов', path: routes.audioCall, svgClass: 2 },
  { title: 'Мини-игра Квиз', path: routes.quiz, svgClass: 5 },
